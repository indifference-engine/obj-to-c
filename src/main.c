...
int main(const int argc, const char *const *const argv)
{
  ...
  if (argc < 19)
  {
    throw("At least 18 arguments are required:\n",
  ...
  opaque_cutout_pass_data_macro_name = argv[3];
  opaque_pass_data_macro_name = argv[4];
  opaque_draw_call_data_macro_name = argv[5];
  cutout_pass_data_macro_name = argv[6];
  cutout_draw_call_data_macro_name = argv[7];
  opaque_cutout_pass_macro_name = argv[8];
  opaque_draw_call_macro_name = argv[9];
  cutout_draw_call_macro_name = argv[10];
  additive_blended_pass_data_macro_name = argv[11];
  additive_pass_data_macro_name = argv[12];
  additive_draw_call_data_macro_name = argv[13];
  blended_pass_data_macro_name = argv[14];
  blended_draw_call_data_macro_name = argv[15];
  additive_blended_pass_macro_name = argv[16];
  additive_draw_call_macro_name = argv[17];
