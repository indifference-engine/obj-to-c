...
tests/results/%.c: tests/cases/%/input.obj dist/obj_to_c
	mkdir -p $(dir $@)
	dist/obj_to_c test_object_prefix_ test_material_prefix_ TEST_OPAQUE_CUTOUT_PASS_DATA_MACRO_NAME TEST_OPAQUE_PASS_DATA_MACRO_NAME TEST_OPAQUE_DRAW_CALL_DATA_MACRO_NAME TEST_CUTOUT_PASS_DATA_MACRO_NAME TEST_CUTOUT_DRAW_CALL_DATA_MACRO_NAME TEST_OPAQUE_CUTOUT_PASS_MACRO_NAME TEST_OPAQUE_DRAW_CALL_MACRO_NAME TEST_CUTOUT_DRAW_CALL_MACRO_NAME TEST_ADDITIVE_BLENDED_PASS_DATA_MACRO_NAME TEST_ADDITIVE_PASS_DATA_MACRO_NAME TEST_ADDITIVE_DRAW_CALL_DATA_MACRO_NAME TEST_BLENDED_PASS_DATA_MACRO_NAME TEST_BLENDED_DRAW_CALL_DATA_MACRO_NAME TEST_ADDITIVE_BLENDED_PASS_MACRO_NAME TEST_ADDITIVE_DRAW_CALL_MACRO_NAME TEST_BLENDED_DRAW_CALL_MACRO_NAME test/include/a.h test/include/b.h test/include/c.h < $< > $@
